...
public class PostController {
    ...
    public ResponseEntity<String> registerPosts(RegisterPostDto registerPostDto) {
        try {
    ...
    public ResponseEntity<List<Post>> getPostsByCompany(@PathVariable Company companyName) {
        try {
